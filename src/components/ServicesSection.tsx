...
import { Search, MousePointer, Megaphone, Code, Palette, BarChart3, ArrowRight } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: 'Dominate search rankings with our AI-powered SEO strategies that drive organic traffic and boost conversions.',
    ...
    },
    {
      ...
      description: 'Maximize ROI with precision-targeted campaigns across Google Ads, Facebook, and other premium platforms.',
    ...
    },
    {
      ...
      description: 'Build engaged communities and viral content strategies that amplify your brand across all social platforms.',
    ...
    },
    {
      ...
      description: 'Create lightning-fast, conversion-optimized websites that deliver exceptional user experiences.',
      features: ['Responsive Design', 'E-commerce Solutions', 'Performance Optimization', 'CMS Integration'],
    ...
    },
    {
      ...
      description: 'Craft memorable brand identities that resonate with your audience and differentiate from competitors.',
    ...
    },
    {
      ...
      description: 'Make data-driven decisions with comprehensive analytics and actionable insights for continuous growth.',
      ...
      <div ref={ref} className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-6xl font-bold mb-6">
            <span className="text-gradient">360° Digital Solutions</span><br />
            That Drive Results
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            From strategy to execution, we provide comprehensive digital marketing services 
            that transform your online presence and accelerate business growth.
          </p>
        </motion.div>
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="relative p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all duration-500 overflow-hidden h-full">
                ...
                <div className={`absolute inset-0 ${service.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-500`} />
                
                {/* Icon */}
                <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl ${service.gradient} mb-6 group-hover:scale-110 transition-transform duration-500`}>
                ...
                {hoveredCard === index && (
                  <>
                    ...
                    <div className="absolute bottom-4 left-4 w-1.5 h-1.5 bg-cyber-pink rounded-full pulse-glow" style={{ animationDelay: '0.5s' }} />
                  </>
                )}
              </div>
            </motion.div>
        ...
        >
          <div className="p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Let's discuss how our 360° digital solutions can transform your business and drive unprecedented growth.
            </p>
